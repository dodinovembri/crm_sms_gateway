                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body p-0">
                        <div class="mailbox-read-info">
                            <h6>Sender: <?= $inbox->SenderNumber ?>
                                <span class="mailbox-read-time float-right"><?= $inbox->ReceivingDateTime ?></span>
                            </h6>
                        </div>
                        <!-- /.mailbox-controls -->
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content bg-primary">
                                ...
                                <div class="modal-footer justify-content-between">
                                    ...
                                    echo $inbox->ID ?>"><button type="button" class="btn btn-outline-light">Delete Data</button></a>
                                </div>
                            </div>
                            <!-- /.modal-content -->
                        </div>
