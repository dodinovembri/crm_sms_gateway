  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <div class="media">
          <img src="<?php echo base_url() ?>assets/dist/img/logo.png" alt="User Avatar" class="img-size-50 mr-3 img-square">
          <li class="nav-item d-none d-sm-inline-block">
            <h3><a href="https://teknik.univpgri-palembang.ac.id/" class="nav-link">FAKULTAS TEKNIK UNIVERSITAS PGRI PALEMBANG</a></h3>
          </li>
        </div>
      </ul>
